/**
 * WangXianHook v34.32 - Anti-Cheat Bypass + DYLD Hiding + Protocol Login Patch
...
static void log_init(void) {
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:p]) {
        g_logPath = p;
        _log(@"=== WXHook v34.32 Full Protocol Patch ===");
    ...
    if (port == 5678 && ret >= 13) {
        ...
        if (cmd == 0x802EE113) {
            ...
            if (status4 != 0 || ret <= 64) {
                ...
                const char fakeServerList[] = "\x00\x00\x05\x60\x80\x2E\xE1\x13\x00\x00\x00\x00\x00\x10\xE4\xB8"
                    ...
                    "\x84\x89\xE5\xBF\xAB\x21\x00\x00\x00\x66\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x06\xE4\xB8\x80\xE5\x8C\xBA\x00\x09\xE4\xBA\x91\xE6\xA0"
                    "\x96\xE5\xB3\xB0\x00\x0E\x31\x33\x39\x2E\x31\x39\x36\x2E\x31\x35\x2E\x31"
                    "\x31\x38\x00\x00\x2E\xE3\x00\x00\x00\x00\x00\x04\x00\x06\xE7\x81\xAB\xE7"
                    "\x88\x86\x00\x13\xE7\xA5\x9D\xE6\x82\xA8\xE4\xBB\x99\xE9\x80\x94\xE6\x84"
                    "\x89\xE5\xBF\xAB\x21\x00\x00\x00\x6E\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x06\xE4\xB8\x80\xE5\x8C\xBA\x00\x09\xE9\x86\x89\xE4\xBB\x99"
                    "\xE8\xB0\xA3\x00\x0F\x31\x30\x31\x2E\x31\x33\x32\x2E\x31\x30\x32\x2E\x32"
                    "\x30\x39\x00\x00\x2E\xE3\x00\x00\x00\x00\x00\x04\x00\x06\xE7\x81\xAB\xE7"
                    "\x88\x86\x00\x13\xE7\xA5\x9D\xE6\x82\xA8\xE4\xBB\x99\xE9\x80\x94\xE6\x84"
                    "\x89\xE5\xBF\xAB\x21\x00\x00\x00\x71\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x06\xE4\xB8\x80\xE5\x8C\xBA\x00\x09\xE7\x8E\x84\xE5\xA4\xA9"
                    "\xE5\x9F\x9F\x00\x0C\x34\x37\x2E\x31\x30\x33\x2E\x32\x36\x2E\x31\x33\x00"
                    "\x00\x2E\xE3\x00\x00\x00\x00\x00\x04\x00\x06\xE7\x81\xAB\xE7\x88\x86\x00"
                    "\x13\xE7\xA5\x9D\xE6\x82\xA8\xE4\xBB\x99\xE9\x80\x94\xE6\x84\x89\xE5\xBF"
                    "\xAB\x21\x00\x00\x00\x5A\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x06\xE4\xB8\x80\xE5\x8C\xBA\x00\x09\xE9\x80\x8D\xE9\x81\xA5\xE6\xB4\xA5"
                    "\x00\x0D\x34\x37\x2E\x31\x30\x31\x2E\x31\x38\x38\x2E\x38\x36\x00\x00\x2E"
                    ...
                    "\x00\x00\x00\x38\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x06\xE4"
                    "\xB8\x80\xE5\x8C\xBA\x00\x09\xE8\x8B\x8D\xE6\xBE\x9C\xE5\x9F\x9F\x00\x0D"
                    "\x34\x37\x2E\x31\x30\x32\x2E\x31\x34\x36\x2E\x33\x39\x00\x00\x2E\xE3\x00"
                    "\x00\x00\x00\x00\x04\x00\x06\xE7\x81\xAB\xE7\x88\x86\x00\x13\xE7\xA5\x9D"
                    "\xE6\x82\xA8\xE4\xBB\x99\xE9\x80\x94\xE6\x84\x89\xE5\xBF\xAB\x21\x00\x00"
                    "\x00\x1F\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x06\xE4\xB8\x80"
                    "\xE5\x8C\xBA\x00\x09\xE5\xB7\xA8\xE7\xA5\x9E\xE5\xB3\xB0\x00\x0E\x34\x37"
                    "\x2E\x31\x30\x31\x2E\x32\x30\x33\x2E\x32\x30\x32\x00\x00\x2E\xE3\x00\x00"
                    "\x00\x00\x00\x04\x00\x06\xE7\x81\xAB\xE7\x88\x86\x00\x13\xE7\xA5\x9D\xE6"
                    "\x82\xA8\xE4\xBB\x99\xE9\x80\x94\xE6\x84\x89\xE5\xBF\xAB\x21\x00\x00\x00"
                    "\x26";
                ...
                if (fakeLen <= len) {
                    ...
                    ret = (ssize_t)fakeLen;
                    DLOG(@"[PROTO-PATCH] Fake server list (0x802EE113) injected (len=%zu)", fakeLen);
                } else {
                    DLOG(@"[PROTO-PATCH] Buffer too small for 0x802EE113 fake response (%zu < %zu)", len, fakeLen);
                }
            }
        }
